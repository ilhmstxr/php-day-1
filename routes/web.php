...
Route::get('jenis_kontak/{id}/tambah',[JContactController::class,'tambah'])->name('jenis_kontak.tambah');
Route::get('jenis_kontak/{id}/hapus', [JContactController::class, 'hapus'])->name('jenis_kontak.hapus');

Route::get('master_contact/{id}/hapus', [ContactController::class, 'hapus'])->name('master_contact.hapus');
